...
"die Gleichberechtigung","die Integration","der/die Nachfolger/-in","der/die Schwerbehinderte","die Norm","das Qualitätsmanagementsystem","die Anforderung", "verhandeln","unbeschadet","die Entwicklung","der Schutz",
  ...
  "das Treibhausgas","das Ökosystem","verengen","die Umwälzung",
  "die Urheberrecht","unbeschadet","das Vorurteil","der Ausstoß",
  "das Bündnis","zusammenziehen","die Überzeugung","der Waffenstillstand",
  "der Friedensabkommen","der Vorderradantrieb","der Leistungssportler","der Kriegsgefangener",
  "das Herrschaftsgebiet","der Vernichtungslager","die Gegensprechanlage","der Mittelhandknochen",
  "Da gibt es die einen","der Mindesthaltbarkeitsdatum","...geschweige denn...","Gerade noch rechtzeitig",
  "zur Verwendung kommen","Das Lebensmittelgeschäft","auf die Palme bringen","die Menschenrechtsverletzung",
  "die Niedergeschlagenheit","aufziehen aufgezogen","der Schwangerschaftsabbruch","der Universitätsabschluss",
  "die Zartbitterschokolade","Vereinigtes Königreich","Angebot und Nachfrage","spülmaschinentauglich",
  "auf Kritik reagieren","die Streichholzschachtel","die Schädlingsbekämpfung","der Holocaust-Überlebender",
  "an der Leine geführen","vereinfachungshalber","die Höchstgeschwindigkeit","der Teilchenbeschleuniger",
  "die Kreditkartenschulden","die Fremdenfeindlichkeit","in gewisser Hinsicht","die Schöpfungsgeschichte",
  "der Hochtöner-Lautsprecher","die Ultraschalluntersuchung","auf Gedeih und Verderb","die Selbstbeweihräucherung",
  "das Verteidigungsministerium","die Meinungsverschiedenheit","die Öffentlichkeitsarbeit","die Luftverkehrswirtschaft",
  "das Beratungsunternehmen","der Unabhängigkeitskrieg","die Nahrungsergänzungsmittel","Pkw (der Personenkraftwagen)",
  "Auf die Plätze...Fertig...Los!","Viertel vor/nach zwei (zwei Uhr)","die Überschallgeschwindigkeit","der Organismus",
  "die Datenvisualisierung","die Elektrizität","die Integrität","die Loyalität",
  "der Antisemitismus","an einer Besprechung teilnehmen","die Kontinuität","Alles paletti (wenig benutzt)",
  "die Rivalität","die Brutalität","die Realisierung","die Priorität",
  "der Kreuzschlitzschraubenzieher","der Buddhismus","der Hinduismus","die Sensibilität",
  "die Popularität","Tausende und Abertausende","die Subtilität","die Spiritualität",
  "die Profanität","der Offentlichenverkehrsmittel","die Kapazität","die Röntgenstrahlung",
  "die Genialität","zum Besseren oder zum Schlechteren","der Terrorismus","die Weltgesundheitsorganisation",
  "das Grundgesetz","erneuerbar","verfassungsmäßig","die Strahlung",
  "die Nachhaltigkeit","die Verfassung","die Steuerhinterziehung","verfassungswidrig",
  "die Bürokratie","die Hierarchie","die Gesetzgebung","die Investition",
  "der Algorithmus","die Hintergrundstrahlung","die Hypothek","die Ausstrahlung",
